...
// 1. SQL文を用意
$stmt = $pdo->prepare("INSERT INTO kadai_php5_piano(id, name, mail, age, composer, songtitle, learningterm, degree, playingtime, level, appealpoint, img, indate)VALUES(NULL, :name, :mail, :age, :composer, :songtitle, :learningterm, :degree, :playingtime, :level, :appealpoint, :img, sysdate())");
